...
import 'package:filter_listview_example/api/api.dart';
import 'package:filter_listview_example/main.dart';
import 'package:filter_listview_example/model/employemodel.dart';
import 'package:filter_listview_example/page/viewdetails.dart';
...
class FilterNetworkListPageState extends State<FilterNetworkListPage> {
  ...
  Widget buildBook(employelistModel book) => InkWell(
    onTap: (){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ViewDetails(name: book.name!,email: book.email!,img: book.profileImage!,username: book.username!,)),
      );
